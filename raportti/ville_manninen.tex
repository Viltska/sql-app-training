...
\lstinputlisting[language=Java]{E:/Koulu/Tietokantojen Perusteet/sql-app-training/src/Tikape/Main.java}

\newpage
\subsection*{DatabaseManager.java}
\lstinputlisting[language=Java]{E:/Koulu/Tietokantojen Perusteet/sql-app-training/src/Tikape/DatabaseManager.java}

\newpage
\subsection*{Asiakkaat.java}
\lstinputlisting[language=Java]{E:/Koulu/Tietokantojen Perusteet/sql-app-training/src/Tikape/Asiakkaat.java}
\newpage
\subsection*{Paikat.java}
\lstinputlisting[language=Java]{E:/Koulu/Tietokantojen Perusteet/sql-app-training/src/Tikape/Paikat.java}
\newpage
\subsection*{Paketit.java}
\lstinputlisting[language=Java]{E:/Koulu/Tietokantojen Perusteet/sql-app-training/src/Tikape/Paketit.java}
\newpage
\subsection*{Tapahtumat.java}
\lstinputlisting[language=Java]{E:/Koulu/Tietokantojen Perusteet/sql-app-training/src/Tikape/Tapahtumat.java}
\end{document}