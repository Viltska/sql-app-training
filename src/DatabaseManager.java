...
public class DatabaseManager {
    ...
    public void tehokkuusTesti() throws SQLException {
        ...
        try {
            ...
            for (int i = 1; i < 1001; i++) {
                int j = rand.nextInt(1000) + 1;
                PreparedStatement p = db.prepareStatement("SELECT COUNT(*) AS Laskuri FROM Tapahtumat, Paketit WHERE Tapahtumat.paketti_id = Paketit.id AND Paketit.seurantakoodi = ?");
